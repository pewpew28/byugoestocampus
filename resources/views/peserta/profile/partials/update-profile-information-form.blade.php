<section>
    ...
    <form method="post" action="{{ route('profile.update') }}">
        ...
        <div>
            ...
            <x-text-input id="npsn" name="npsn" type="text" class="mt-1 block w-full" :value="old('npsn', $user->npsn)" required autofocus autocomplete="npsn" />
        ...
        <div>
            <x-input-label for="telp" :value="__('Nomor Whatsapp')" />
