...
@section('judul')
    <div class="text-2xl font-bold uppercase breadcrumbs text-black">
        <ul>
            ...
            <li><a href="{{ route('proposal') }}">Proposal</a></li>
            <li>Edit</li>
        </ul>
    </div>
@endsection
...
@section('content')
    <div class="pb-12">
        <div class="w-full h-full px-24 pb-4 flex gap-4 mt-4">
            <div>
                <a href="{{ route('proposal.edit',['id_proposal'=>$proposal->id]) }}">
                    <button
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    @include('peserta.project.proposal.partials.ide-bisnis')
                </div>
            </div>

            {{-- <div class="sm:p-8 bg-white shadow sm:rounded-lg mt-4">
                <div class="max-w-xl">
                    @include('peserta.project.proposal.partials.laba-rugi')
                </div>
            </div>

            <div class="sm:p-8 bg-white shadow sm:rounded-lg mt-4">
                <div class="max-w-xl">
                    @include('peserta.project.proposal.partials.pemasaran')
                </div>
            </div>

            <div class="sm:p-8 bg-white shadow sm:rounded-lg mt-4">
                <div class="max-w-xl">
                    @include('peserta.project.proposal.partials.maintenance')
                </div>
            </div> --}}
        </div>
    </div>
