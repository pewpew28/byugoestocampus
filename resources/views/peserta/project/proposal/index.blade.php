...
@section('content')
    <div class="pb-12">
        <div class="w-full h-full px-24 pb-4 flex gap-4 ">
            <div>
                <a href="{{ route('proposal.edit', ['id_proposal' => $id_proposal]) }}">
                    <button
                        class="btn {{ request()->routeIs('proposal.edit') ? 'border-none text-white bg-red-600 scale-100' : 'border-white bg-white text-red-600 hover:bg-white hover:border-2 hover:border-red-600' }}">Edit Proposal</button>
                </a>
            </div>
            <div>
